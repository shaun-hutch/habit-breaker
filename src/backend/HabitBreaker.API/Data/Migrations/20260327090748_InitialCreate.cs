...
namespace HabitBreaker.API.Data.Migrations
{
    /// <inheritdoc />
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    PreferredReminderTime = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_FoodLogs_UserHabits_UserHabitId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MealEntries_FoodLogs_FoodLogId",
            ...
            migrationBuilder.InsertData(
                table: "Habits",
                columns: new[] { "Id", "DefaultDurationDays", "Description", "Name" },
                values: new object[] { 1, 66, "Track your daily food and drink intake to build healthier eating habits.", "Better Eating" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FoodLogs_UserHabitId_LogDate",
                table: "FoodLogs",
                columns: new[] { "UserHabitId", "LogDate" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_MealEntries_FoodLogId",
                table: "MealEntries",
                column: "FoodLogId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserHabits_UserId_HabitId_IsActive",
                table: "UserHabits",
                columns: new[] { "UserId", "HabitId", "IsActive" });
        }
